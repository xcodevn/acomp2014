...
$theme = "theme_light"; // name of the subfolder in themes directory for the theme you want
...
/* Tilegroup settings */
$groupTitles = array('Home','Call for papers','Information'); // titles of the tileGroups
$groupSpacing = array(7,7, 7); // width of each tileGroup (spacing between the groups in tiles)
...
$disableGroupScrollingWhenVerticalScroll = true; // if the page is too high and not all tiles fit on screen, mousewheel triggers vertical scroll instead of tilegroup scroll. Set to false if you want always to have groupScrolling
